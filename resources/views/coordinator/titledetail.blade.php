...
<div class="container mt-5" style="border:solid; padding-bottom: 30px; margin-bottom: 20px;">
	...
	<div class="row">
		...
		<div class="col-12">
			...
			<h3 class="mt-3 " style="text-transform: uppercase;">Proposed by: {{ $titleinfo->name }}</h3>
			...
			<div class="mt-3" style="border: solid; padding: 0 5px;">
				...
				<form class="h-100" style="margin: 5px;" method="post" action="/comment/{{ $titleinfo->id}}">
					@method('patch')
					@csrf
		...
		<div class="container d-flex justify-content-end mt-5">
				   ...
				   <form class="form-inline" action="/accepted/{{$titleinfo->id}}" method="POST">
				    {{csrf_field()}}
